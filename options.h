/*
 * options.h: defines for the compile-time configuration of the MUD-OS driver
 */
 ...
 *
 * The advantage is that when you upgrade to a newer MUD-OS driver, you can
 ...
 *                          COMPATIBILITY                                   *
 *                         ---------------                                  *
 * The MUD-OS driver has evolved quite a bit over the years.  These defines  *
 ...
 *                                                                          *
 * WARNING: If you are using software designed to run with the MUD-OS driver *
 *          it may assume certain settings of these options.  Check the     *
 *          instructions for details.                                       *
 ****************************************************************************/

/* HAS_STATUS_TYPE: old MUD-OS drivers had a 'status' type which was
...
/* NO_WIZARDS: for historical reasons, MUD-OS used to keep track of who
 ...
 */
#define DEFAULT_PRAGMAS PRAGMA_WARNINGS + PRAGMA_ERROR_CONTEXT + PRAGMA_SAVE_BINARY
...
/* TRAP_CRASHES:  define this if you want MUD-OS to call crash() in master.c
