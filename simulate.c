...
void error_handler P1(char *, err)
{
	...
	if (current_heart_beat) {
	    static char hb_message[] = "MUD-OS driver tells you: You have no heart beat!\n";
...
void shutdownMudOS P1(int, exit_code)
{
    ...
    shout_string("MUD-OS driver shouts: shutting down immediately.\n");
#ifdef PACKAGE_MUDLIB_STATS
    save_stat_files();
#endif
#ifdef PACKAGE_DB
...
void slow_shut_down P1(int, minutes)
{
	...
	shout_string("MUD-OS driver shouts: Out of memory.\n");
	restore_command_giver();
